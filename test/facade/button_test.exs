defmodule Surface.Components.ButtonTest do
  ...
  test "creates a <button> with type and class button" do
    ...
    assert html =~ """
           <button aria-label="test" class="button p-5" type="button">
             Ok
           </button>
           """
  end
  ...
  test "classes propagate to button" do
    ...
    assert html =~ """
           <button class="custom custom2" type="button">
             Ok
           </button>
           """
  end
  ...
  test "aria label" do
    ...
    assert html =~ """
           <button aria-label="Ok" class="button" type="button">
             Ok
           </button>
           """
  end
